-- Expand **Lab environment & tooling** to match tools named across the 30-day curriculum
-- (Node 20, Python venv, pip stacks, Postman, Vercel/Supabase/HF, Ollama, design tools, optional GPU, API keys).
