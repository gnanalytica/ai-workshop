...
import { CreateCohortForm } from "@/app/(authed)/admin/schedule/CreateCohortForm";
import { CohortRowActions } from "@/app/(authed)/admin/schedule/CohortRowActions";

export default async function AdminCohortSchedulePage({
  params,
}: {
