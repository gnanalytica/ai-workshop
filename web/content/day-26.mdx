...
By Day 26 you've written enough AI-assisted code to feel the tax: every new chat starts dumb. Today we fix that. Context engineering is the discipline of writing *for the model that will read your repo tomorrow*.
...
> *Why this matters.* Tomorrow you ship the audio/video pitch reel for Demo Day. If your context files are honest, the agent stops asking "where does auth live?" every turn.
...
Day 27 is **Text2Audio, Text2Video** — your capstone gets a 30-second pitch reel.

- [ ] ElevenLabs free tier account (10k chars/month).
- [ ] HeyGen free trial (1 minute of video per month).
- [ ] A 30-second clean voice recording of yourself reading any paragraph — we'll clone it.
- [ ] A 30-second polished script of your capstone pitch.
