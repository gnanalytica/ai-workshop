...
Day 22 is **Data Visualization** — you'll turn one slice of your capstone's data into three charts a stranger can read in 10 seconds.

- [ ] Export one CSV from your capstone (or any usage analytics you have). 50–500 rows is fine.
- [ ] Keep today's RAG store on disk — we may revisit it for retrieval analytics.
- [ ] Bring one chart from a competitor you'd steal the *form* of, and one chart you've seen that misled you.
