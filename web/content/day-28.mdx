...
weekday: "Saturday"
week: 5
topic: "AI Ethics, Safety, Guardrails, Red-teaming"
faculty:
  main: "Jayasaagar"
  support: "Aparna"
reading_time: "10 min"
...
1. Run ≥10 attacks against your own Day-23 chatbot and logged what broke.
...
- [ ] Day-23 chatbot running locally.
...
1. Open your Day-23 chatbot. Open a doc titled `redteam.md`.
...
**Submit.** Paste `risk-note.md` as text on the dashboard (or add a link to it) before next class.

**Rubric.** Specificity of harms (4) · Mitigation realism (4) · Honest residual risk owned (2).

## 🔁 Prep for next class

Day 29 — **Demo Day 1.** First half of the cohort presents 5-minute live builds to the panel.
