...
weekday: "Tuesday"
week: 5
topic: "Capstone Milestone 3: Workspace Setup and First Deploy"
faculty:
  main: "Sandeep"
  support: "Aparna"
reading_time: "10 min"
...
> 🚩 **Milestone 3.** This is a graded capstone checkpoint. By end of class, your project must have a public URL. No URL = no milestone.
...
## 📝 Assignment · Milestone 3 submission
...
**Submit.** All three on the dashboard before Day 25.
...
Day 25 covers **GEO, AEO, leaderboards, benchmarking, and keeping up with AI**.

- [ ] Ask ChatGPT, Claude, Perplexity: *"What are the best [your capstone category] tools in India in 2026?"* Save the answers.
- [ ] Bookmark **lmarena.ai** and **Hugging Face leaderboards**.
- [ ] Bring one question about how new models actually get ranked.
