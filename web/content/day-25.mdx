...
weekday: "Wednesday"
week: 5
topic: "GEO, AEO, Leaderboards, Benchmarking, Keeping up with AI"
faculty:
  main: "Jayasaagar"
  support: "Aparna"
reading_time: "10 min"
...
tags: ["geo", "aeo", "benchmarks", "leaderboards", "career"]
software: []
...
**Submit.** Dashboard → Day 25 → 2 source URLs + 1 commit link.

**Rubric.** Realistic feed picks (3) · One actually-shipped GEO change (4) · Honest unsubscribe note (3).

## 🔁 Prep for next class

Day 26 is **Context Engineering: CLAUDE.MD, AGENTS.MD, Rules and Skills.**

- [ ] Make sure your capstone repo is cloned locally with at least 3 files of real code.
- [ ] Skim the Anthropic Claude Code best-practices page and the agents.md homepage.
- [ ] One sentence: *"The thing the AI keeps getting wrong about my project is ___."* Bring it.
