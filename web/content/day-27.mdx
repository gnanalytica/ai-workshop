...
- [ ] A 30-second polished script of your capstone pitch — sharpen the version you drafted earlier this week.
...
**Submit.** Reel URL + posted link on dashboard before Day 28.

**Rubric.** Audio is clean (no robot tells) (4) · Visuals match the script beats (4) · Posted publicly with a real caption (2).

## 🔁 Prep for next class

Day 28 — **AI Ethics, safety, guardrails, and red-teaming**.

- [ ] Pull up your Day-23 chatbot — we'll attack it tomorrow.
- [ ] Read OWASP LLM Top 10 (skim) — focus on prompt injection and sensitive info disclosure.
- [ ] Bring one screenshot of a real-world chatbot failure or a jailbreak you've seen.
