...
Note: this migration is deliberately limited to column + index. No RLS change — Plan 2 rewrites the policies cleanly. The column exists from this migration so Plan 2 can reference it.
