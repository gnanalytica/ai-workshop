# Faculty onboarding — Gnanalytica Learn
...
## Register / enroll (first time)

1. Open **[https://learn.gnanalytica.com](https://learn.gnanalytica.com)**.
2. Go to **Sign up** (or the start / enrollment flow from the home page).
...
## Sign in later (returning users)

1. Open **[https://learn.gnanalytica.com](https://learn.gnanalytica.com)**.
2. Use **Sign in** and **Sign in with Google** with the same account you used to enroll.

You should land in the app and can open the **Dashboard** from the navigation.

---

## Faculty dashboard (what to expect)
...
Use **Help desk** in the app, or reply to the email / channel where you received your invite codes.

---

*Faculty invite code for this cohort: **FAC-YCCUSG**.*
